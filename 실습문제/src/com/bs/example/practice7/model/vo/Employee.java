...
public class Employee {
	...
	public String result() {
		return this.getEmpNo() +" "+this.getEmpName()+" "+this.getDept()+" "+this.getJob()+" "+this.getAge()+" "+this.getGender()+" "+this.getSalary()+" "+this.getBonusPoint()+" "+this.getPhone()+" "+this.getAddress();
	}
